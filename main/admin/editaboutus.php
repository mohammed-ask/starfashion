...
<div class="row">
    <div class="col-12 mobile-bottom-margin">
        <div class="card card-default">
            ...
            <form style="overflow-x: hidden;" id="adduser" onsubmit="event.preventDefault();sendForm('id', '<?= $row['id'] ?>', 'updateaboutus', 'resultid', 'adduser');return 0;">
                <div class="card-body">
...
';
$pagemeta = "";
$pagetitle = "Edit About Us::.Manage About Us-Admin";

...
<div class="row">
    <div class="col-12 mobile-bottom-margin">
        <div class="card card-default">
            ...
            <form style="overflow-x: hidden;" id="adduser" onsubmit="event.preventDefault();sendForm('id', '<?= $row['id'] ?>', 'updatereturn', 'resultid', 'adduser');return 0;">
                <div class="card-body">
...
';
$pagemeta = "";
$pagetitle = "Edit Retruns::.Manage Retruns-Admin";
$pageheader = "Manage Retruns";

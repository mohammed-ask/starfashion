...
$id = $_GET['hakuna'];
$result = $obj->selectextrawhere("terms_condition", "id=$id");
    ...
    <div class="col-12 mobile-bottom-margin">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Edit Terms and Condtion</h3>
            </div>
            <form style="overflow-x: hidden;" id="adduser" onsubmit="event.preventDefault();sendForm('id', '<?= $row['id'] ?>', 'updatetermsandco', 'resultid', 'adduser');return 0;">
                <div class="card-body">
...
';
$pagemeta = "";
$pagetitle = "Edit Terms and Condition::.Manage Terms and Condition-Admin";
